...
import 'package:siakmhs_1001210005_2/features/app/splash_screen/splash_screen.dart';
...
import 'features/user_auth/presentation/pages/edit_profile_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: ThemeData(
        ...
        // Atau, jika ingin menggunakan font khusus untuk heading
        textTheme: TextTheme(),
      ),
      ...
      routes: {
        ...
        '/my_ticket_page' : (context) => MyTicketPage(),
